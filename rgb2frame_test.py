...
def main():
    ...
    parser.add_argument('source', type=str, help='C:\Users\savet\Downloads\sample\FN_CH12_A04_013_L20M02_01_F')
    parser.add_argument('dest_folder', type=str, help='C:\Users\savet\Downloads\sample\sample_frames')
